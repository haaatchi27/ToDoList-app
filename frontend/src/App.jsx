...
function AppContent() {
    ...
    const handleReorder = async (parentId, draggedId, targetId) => {
        // ... (Same reorder logic as before, using api to update)
        // Note: For brevity, I'm assuming the existing complex reorder logic from original App.jsx
        // is maintained here, just calling fetchTasks() after success.
        if (parentId === null) {
    ...
    if (authLoading) return <div className="loading-screen">読み込み中...</div>;
        ...
        <div className="app-container">
            <header className="app-header">
                <div className="header-top">
                    <button className="btn btn-ghost btn-sm" onClick={logout}>ログアウト</button>
                </div>
